...
function getSparked()  { try { return new Set(JSON.parse(localStorage.getItem('vl-sp')||'[]')); } catch { return new Set(); } }
function saveSparked(s){ try { localStorage.setItem('vl-sp', JSON.stringify([...s])); } catch {} }
function ageVerified() { try { return localStorage.getItem('vl-age')==='1'; } catch { return false; } }
function setAgeOk()    { try { localStorage.setItem('vl-age','1'); } catch {} }
